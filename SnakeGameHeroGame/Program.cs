...
namespace SnakeGame
{
    class Program
    {
        ...
        static void Menu()
        {
            ...
            Console.WriteLine("Snake/HeroGame/End");
            string Menu = Console.ReadLine();
            if (Menu.ToLower() == "snake")
            {
                Snake();
                Console.WriteLine("Closing the game");
                Thread.Sleep(1000);
            }
            else if (Menu.ToLower() == "herogame")
            {
                HeroGame();
                Console.WriteLine("Closing the game");
                Thread.Sleep(1000);
            }
            else if (Menu.ToLower() == "end")
            {
        ...
        static void Snake()//hva skjer om du endrer dette metodenavnet?
        {
            ...
            Console.WriteLine("What speed do you want snake to go Slow/Medium/Fast");
            string SnakeSpeed = Console.ReadLine();
            int delayInMillisecs = 0;
            if (SnakeSpeed.ToLower() == "slow")
            {
                delayInMillisecs = +80;
            }
            else if (SnakeSpeed.ToLower() == "medium")
            {
                delayInMillisecs = +50;
            }
            else if (SnakeSpeed.ToLower() == "fast")
            {
                delayInMillisecs = +20;
            }
